...
if __name__ == "__main__":
    ...
    # Expected shapes:
    # train_X: (batch_size, 81, 64) real tensor (input sequence)
    # train_Y: (batch_size, 40, 64) real tensor (next 40 steps)
    # val_X: (batch_size, 81, 64) real tensor
    # val_Y: (batch_size, 40, 64) real tensor
    ...
    model_real = SpinBosonRealPINN(sequence_length=81, state_size=64, hidden_size=128, ostl_steps=ostl_steps).to(device)

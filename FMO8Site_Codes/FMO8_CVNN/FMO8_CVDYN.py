...
from FMO8CV_mlp import SpinBosonCVPINN, ComplexLinear, CRELU
...
# Load Model
model = torch.load(
    r"D:\FMO_8site_jia.etal\CVNN_8site\saved_models_8siteCVNew\fmo_model_epoch96328_vloss1.8954e-07.pth",
    map_location=device,
    weights_only=False
)
...
# Load ONE Test File
test_file = r"D:\FMO_8site_data_init1\Test_data\8_initial-1_gamma-350.0_lambda-280.0_temp-90.0.npy"   # <--- change filename here
...
ax1.set_title("FMO 8-Site: CVNN", fontsize=45)
ax1.grid(True)
...
diag_handles = [
    ...
    plt.Line2D([0], [0], color='lightseagreen', linewidth=4, linestyle='-', label=r"$\rho_{88}$"),
]
ax1.legend(handles=diag_handles, fontsize=25, ncol=2, loc='upper right')
ax1.set_ylim(0.0, 1.05)

# Off-diagonal elements
off_diag_indices = {"ρ₁₂": 1, "ρ₂₃": 9, "ρ₃₄": 16}
...
ax2.legend(handles=offdiag_handles, fontsize=25, ncol=2, loc='upper right')

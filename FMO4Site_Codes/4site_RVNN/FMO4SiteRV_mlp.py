...
def train_model(model, train_X, train_Y, val_X, val_Y, epochs, lr,lambda_trace, save_dir="saved_models"):
    ...
    np.savez('4_siteHyp_rvnn_losses.npz',
    ...
    print(f"Losses saved to '4_siteHyp_rvnn_losses.npz'")
...
if __name__ == "__main__":
    ...
    model_real = SpinBosonRealPINN(sequence_length=81, state_size=16, hidden_size=82, ostl_steps=ostl_steps).to(device)

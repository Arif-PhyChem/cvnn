...
import sys
sys.path.append("D:/4_site_HYP_CVNN")
from FMO4SiteCV_mlp import SpinBosonCVPINN, ComplexLinear, CRELU
...
# Load Model
model = torch.load(
    r"D:\4_site_HYP_CVNN\saved_models_4siteCVNEW\fmo_model_epoch98979_vloss6.1245e-07.pth",
    map_location=device,
    weights_only=False
)
...
# Load Test File
test_file = r"D:/4_sites_hypothetical/4_sites_hypothetical/test_data/4_initial-1_gamma-375.0_lambda-100.0_temp-150.0.npy" 
...
ax1.set_title("4-Site Hyp Model: CVNN", fontsize=45)
ax1.grid(True)

...
sys.path.append("E:/FMO_RVNN")
from FMO7RV_mlp import SpinBosonRealPINN, RealLinear
...
model = torch.load(
    r"E:\FMO_RVNN\saved_models_FMORV_New\real_mlp_model-96028-tloss-1.3592e-07-vloss-1.6257e-07.pth",
    map_location=device,
    weights_only=False
)
model.eval()
...
# Pick ONE test file
test_file = r"E:\7_sites_adolph_renger_H\test_data\init_1\7_initial-1_gamma-350.0_lambda-70.0_temp-30.0.npy"
print("Running predictions on:", test_file)

# Directory to save results
save_dir = "E:/FMO_RVNN/results"
...
ax1.set_title("FMO: RVNN", fontsize=45)
...
# Off-diagonals
ax2 = axs[1]
off_diag_indices = {"ρ₁₂": (1, 2), "ρ₂₃": (14, 15), "ρ₃₄": (25, 26)}
